...
llm_backend_registry.register("openai", lambda model, api_key=None, base_url=None, name="openai", client=None, max_tokens_parameter="max_tokens", include_temperature=True, **kwargs: OpenAIChatBackend(OpenAIBackendConfig(model=model, api_key=api_key, base_url=base_url, name=name, max_tokens_parameter=max_tokens_parameter, include_temperature=include_temperature), client=client))
